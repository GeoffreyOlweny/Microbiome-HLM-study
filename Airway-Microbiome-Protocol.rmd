...
combined_plot <- ggdraw() +
  ...
  draw_label("DMM Microbial Communities/Pulmotypes", 
             x = 0.5, y = 0.95, hjust = 0.5, size = 16, fontface = "bold")
print(combined_plot)
ggsave("Results/Figure 3.jpg", plot = combined_plot, dpi = 600, width = 8, height = 10)
...
print(alpha_metaDR1)
ggsave("Results/Figure 4.jpg",alpha_metaDR1, width = 8, height =10,limitsize = FALSE, dpi=600)
...
ggsave("Results/Figure 5.jpg",Beta_diversity, width = 8, height =10,limitsize = FALSE, dpi=600)
...
ggsave("Results/Figure 6.jpg", plot = combined_plot, width = 8, height = 10, dpi = 600)  
```
## **Genus**
```{r, warning=FALSE, message=FALSE}
# Assign the phyloseq object to a variable
...
# Save the combined plot as a high-resolution JPG file
ggsave("Results/Figure 7.jpg", plot = combined_plot, width = 8, height = 10, dpi = 600)  
```
...
combined_plot <- wrap_plots(plot_list, nrow = 3) + plot_annotation(title = "Differential abundance among Active TB, LTBI and Uninfected Individuals", 
                    tag_levels = "A")  # Automatically adds A, B, and C tags
ggsave(filename = "Results/Figure 8.jpg", plot = combined_plot, width = 8, height = 11, dpi = 600)
...
roc_result <- roc(as.numeric(as.character(test_fold$group)), predictions)
  ...
  # Combine the three plots into rows with A, B, C labels
  combined_plot <- rf_plot / svm_plot / glm_plot + 
    plot_annotation(title = "ROC Curves: Random Forest, SVM, and GLM", 
                    tag_levels = "A")  # Automatically adds A, B, and C tags
  
  # Save the combined plot as a high-resolution image
  ggsave(filename = "Results/Figure 11.jpg", 
         plot = combined_plot, 
         width = 8, height = 10, dpi = 600)
  
  
  return(list(rf_plot = rf_plot, svm_plot = svm_plot, glm_plot = glm_plot, auc_scores = auc_scores, combined_plot))
}
# Example usage
...
ggsave(filename = "Results/Figure 12.jpg", plot = combined_plot, width = 8, height = 10, dpi = 600)
ggsave(filename = "Results/Figure 13.jpg", plot = plot3, width = 8, height = 10, dpi = 600)
