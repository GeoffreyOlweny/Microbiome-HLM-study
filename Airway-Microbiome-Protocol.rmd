...
cran_packages <- c(
  ...
  "caret", "ROCR", "e1071", "gridExtra", "fastDummies", "here"
)
...
for (i in 1:dim(contrast_combinations)[2]) {
    ...
    geom_hline(yintercept = -log2(0.01), linetype = "dashed", color = 'black', size = 0.9) +  # Thicker dashed line for p-value threshold
...
lefse_bar = function(taxtree = tablda[[2]], title = "LEfSe Results Bar Plot") {
  taxtree = tablda[[2]]
...
MicroRoc <- function(otu = NULL, tax = NULL, map = NULL, tree = NULL,
  ...
  labs(
    ...
    title = "Performance of RF, SVM, and GLM Machine Learning Methods"
  ) +
  annotate("text", x = 0.75, y = 0.3, label = paste("Black: ", auc_scores[3], sep = ""))

  # Return the results
  return(list(roc_plot = glm_plot, auc_scores = auc_scores))
}
...
ggsave(filename = "Results/Figure 9B.jpg", plot = combined_plot, width = 10, height = 8, dpi = 600)
ggsave(filename = "Results/Figure 9C.jpg", plot = plot3, width = 10, height = 8, dpi = 600)
