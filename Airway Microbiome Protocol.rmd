...
write.csv(permanova, file = "Results/Genexpert_permanova_results.csv", row.names = TRUE)
...
# Save the combined plot as a high-resolution JPG file
ggsave("Results/Figure 6C.jpg", plot = combined_plot, width = 12, height = 6, dpi = 600)  
```
#####Genus
```{r}
# Assign the phyloseq object to a variable
...
# Save the combined plot as a high-resolution JPG file
ggsave("Results/Figure 6D.jpg", plot = combined_plot, width = 12, height = 6, dpi = 600)  
```
...
micro_rf_analysis <- function(otu = NULL, tax = NULL, map = NULL, tree = NULL,
                              ps = NULL, group = "Group", top_features = 20, 
  ...
  return(list(importance_plot, polar_plot, top_features_df, combined_tables))
}
