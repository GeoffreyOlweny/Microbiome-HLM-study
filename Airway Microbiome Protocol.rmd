...
ggsave(filename = "Results/Figure 1A.jpg", 
...
ggsave(filename = "Results/Figure 1B.jpg", 
       plot = alpha_diversity_final, 
       width = 10, height = 8, dpi = 600)
```
### Beta diversity
...
write.csv(permanova, file = "Result/Genexpert_permanova_results.csv", row.names = TRUE)

ggsave(filename = "Results/Figure 2A.jpg", 
       plot = beta_final, 
       width = 10, height = 8, dpi = 600)
```
...
# Save the data frame to a CSV file
write.csv(permanova, file = "Result/Mtb_infection status_permanova_results.csv", row.names = TRUE)

ggsave(filename = "Results/Figure 2B.jpg", 
       plot = beta_final, 
       width = 10, height = 8, dpi = 600)
```
...
ggsave("Results/Figure 7A.jpg", plot = combined_plot, width = 12, height = 6, dpi = 600)  
```
...
# Save the combined plot as a high-resolution JPG file
ggsave("Results/Figure 7B.jpg", plot = combined_plot, width = 12, height = 6, dpi = 600)  
```
...
# Save the combined plot as a high-resolution JPG file
ggsave("Results/Figure 7C.jpg", plot = combined_plot, width = 12, height = 6, dpi = 600)  
```
#####Genus
```{r}
# Assign the phyloseq object to a variable
...
# Save the combined plot as a high-resolution JPG file
ggsave("Results/Figure 7D.jpg", plot = combined_plot, width = 12, height = 6, dpi = 600)  
```
...
ggsave(filename = "Results/Figure 8.jpg", plot = combined_plot, width = 15, height = 10, dpi = 600)
...
ggsave(filename = "Results/Figure 9A.jpg", 
       plot = roc_plot, 
       width = 10, height = 8, dpi = 600)
...
result <- micro_rf_analysis(ps = MtbInfectionStatus_phyloseq,
                            group = "Group",
                            top_features = 40, perform_rfcv = FALSE, rfcv_folds = 5,
...
ggsave(filename = "Results/Figure 9B.jpg", 
       plot = combined_plot, 
       width = 10, height = 8, dpi = 600)
